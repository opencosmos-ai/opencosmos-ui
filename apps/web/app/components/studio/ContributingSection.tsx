          ...
          <div className="space-y-4">
            <div>
              ...
              <pre className="bg-[var(--color-surface)] p-4 rounded-md text-sm overflow-x-auto border border-[var(--color-border)]">
                <code className="text-[var(--color-text-primary)]">git clone https://github.com/opencosmos-ai/opencosmos-ui.git
...
- [x] Exports updated`}</code>
            ...
            <div className="p-4 bg-[var(--color-surface)] rounded-md border border-[var(--color-border)]">
              ...
              <p className="text-sm text-[var(--color-text-secondary)]">
                Reference specific principles from <a href="https://github.com/opencosmos-ai/opencosmos-ui/blob/main/DESIGN-PHILOSOPHY.md" target="_blank" rel="noopener noreferrer" className="text-[var(--color-primary)] hover:underline">DESIGN-PHILOSOPHY.md</a> that your contribution addresses.
